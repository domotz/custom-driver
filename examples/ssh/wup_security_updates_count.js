 ...
 * Name: Windows Update - Security Updates Count
 * Description: Show the number of updates of any severity classified as "Security" 
 *  
...
function successCallback(output) {
    ...
    var table = D.createTable(
        "Missing Security Updates Count",
        [
