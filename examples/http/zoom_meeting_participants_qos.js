 ...
 * Name: Meeting Participants Quality of Service
 * Description: This script retrieves information about Zoom Meeting Participants Quality of Service
 *
...
const meetingParticipantQosTable = D.createTable("Meeting Participants Quality of Service", meetingParticipantQosProperties)
...
function insertRecord(meetingParticipantQos) {
    ...
    meetingParticipantQosTable.insertRecord(sanitize(meetingParticipantQos.participant_id), recordValues);
}

/**
 * Populates all Meeting Participants Quality of Service into the output table.
 * @param {Array} meetingParticipantsQos - A list of Meeting Participants Quality of Service objects to be inserted into the table.
 */
