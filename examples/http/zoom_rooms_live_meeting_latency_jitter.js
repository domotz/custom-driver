 ...
 *    - Video Input Jitter Avg
 *    - Video Input Latency Avg
 *    - Video Output Jitter Avg
 *    - Video Output Latency Avg
 *    - Video Input Web Jitter Avg
 *    - Video Input Web Latency Avg
 *    - Video Output Web Jitter Avg
 *    - Video Output Web Latency Avg
 *    - Room Name: The name of the Zoom Room being monitored

 *    - AS General In Jitter Avg: Average jitter for incoming general screen-sharing data
 *    - AS General In Latency Avg: Average latency for incoming general screen-sharing data
 *    - AS General Out Jitter Avg: Average jitter for outgoing general screen-sharing data
 *    - AS General Out Latency Avg: Average latency for outgoing general screen-sharing data
 *    - AS RWG In Jitter Avg: Average jitter for incoming screen-sharing data in the RWG channel
 *    - AS RWG In Latency Avg: Average latency for incoming screen-sharing data in the RWG channel
 *    - AS RWG Out Jitter Avg: Average jitter for outgoing screen-sharing data in the RWG channel
 *    - AS RWG Out Latency Avg: Average latency for outgoing screen-sharing data in the RWG channel
 ...
 *
 *
 *    Uncomment the commented objects in the meetingParticipantQosExtractors variable to retrieve additional Metrics:
 *
 *    - Video Input CRC Jitter Avg
 *    - Video Input CRC Latency Avg
 *    - Video Output CRC Jitter Avg
 *    - Video Output CRC Latency Avg
 *    - AS CRC In Jitter Avg: Average jitter for incoming screen-sharing data in the CRC channel
 *    - AS CRC In Latency Avg: Average latency for incoming screen-sharing data in the CRC channel
 *    - AS CRC Out Jitter Avg: Average jitter for outgoing screen-sharing data in the CRC channel
 *    - AS CRC Out Latency Avg: Average latency for outgoing screen-sharing data in the CRC channel
...
const meetingParticipantQosExtractors = [
    ...
    },
    {
        ...
        outputKey: "video_input_jitter"
    },
    {
        key: "video_input",
        label: "Video Input Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_input_latency"
    },
    {
        key: "video_output",
        label: "Video Output Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_output_jitter"
    },
    {
        key: "video_output",
        label: "Video Output Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_output_latency"
    },
    {
        key: "video_device_from_rwg",
        label: "Video Input Web Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_device_from_rwg_jitter"
    },
    {
        key: "video_device_from_rwg",
        label: "Video Input Web Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_device_from_rwg_latency"
    },
    {
        key: "video_device_to_rwg",
        label: "Video Output Web Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "video_device_to_rwg_jitter"
    },
    {
        key: "video_device_to_rwg",
        label: "Video Output Web Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
    ...
    },
    {
        ...
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_input_jitter"
    },
    {
        key: "as_input",
        label: "AS In Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_input_latency"
    },
    {
        key: "as_output",
        label: "AS Out Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_output_jitter"
    },
    {
        key: "as_output",
        label: "AS Out Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_output_latency"
    },
    {
        key: "as_device_from_rwg",
        label: "AS RWG In Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_device_from_rwg_jitter"
    },
    {
        key: "as_device_from_rwg",
        label: "AS RWG In Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_device_from_rwg_latency"
    },
    {
        key: "as_device_to_rwg",
        label: "AS RWG Out Jitter Avg",
        extract: calculateAverageByMetricName,
        metricName: "jitter",
        unit: "ms",
        valueType: D.valueType.NUMBER,
        outputKey: "as_device_to_rwg_jitter"
    },
    {
        key: "as_device_to_rwg",
        label: "AS RWG Out Latency Avg",
        extract: calculateAverageByMetricName,
        metricName: "latency",
        unit: "ms",
        valueType: D.valueType.NUMBER,
...
const outputTable = D.createTable("Rooms Live Meeting Latency and Jitter", meetingParticipantQosProperties)
...
function insertRecord(roomId, roomsQosAverage) {
    const recordValues = meetingParticipantQosProperties.map(function (item) {
        return  (item.valueType === D.valueType.NUMBER && typeof roomsQosAverage[item.outputKey] !== 'number') ? "N/A" : roomsQosAverage[item.outputKey]
    })
...
function retrieveAllMeetingQos(roomDetails) {
    const promises = roomDetails.map(function (room) {
        return retrieveMeetingParticipantQos(room).then(function (responses) {
...
function checkParticipantQosBodyJsonIsNotEmpty(bodyAsJSON) {
